...
type FlatConfig struct {
	...
	BoxManifest         *string           `mapstructure:"box_manifest" cty:"box_manifest"`
	Bucket              *string           `mapstructure:"bucket" cty:"bucket"`
	Version             *string           `mapstructure:"version" cty:"version"`
	BoxTitle            *string           `cty:"box_title"`
	BoxOrg              *string           `cty:"box_org"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"box_manifest":               &hcldec.AttrSpec{Name: "box_manifest", Type: cty.String, Required: false},
		"bucket":                     &hcldec.AttrSpec{Name: "bucket", Type: cty.String, Required: false},
		"version":                    &hcldec.AttrSpec{Name: "version", Type: cty.String, Required: false},
		"box_title":                  &hcldec.AttrSpec{Name: "box_title", Type: cty.String, Required: false},
		"box_org":                    &hcldec.AttrSpec{Name: "box_org", Type: cty.String, Required: false},
	}
	return s
}
